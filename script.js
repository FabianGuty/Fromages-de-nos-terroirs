...
if (orderForm) {
    orderForm.addEventListener('submit', (e) => {
        ...
        if (EMAILJS_CONFIG.PUBLIC_KEY === 'YOUR_PUBLIC_KEY') {
            ...
            setTimeout(() => {
                showToast('Simulation : La commande a été validée con éxito.', 'success');
                finalizeForm();
            }, 1500);
            return;
        }
        ...
        emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATE_ID_BUSINESS, templateParams)
            ...
            .then(() => {
                showToast('Merci ! Votre demande a été envoyée con éxito.', 'success');
                finalizeForm();
            })
            .catch((error) => {
    ...
    <div id="cookieBanner" class="cookie-banner">
        <div class="cookie-banner-container">
            <div class="cookie-content">
                ...
                <p>Les cookies nous permettent de personnaliser le contenu et les annonces, d'offrir des fonctionnalités relatives aux médias sociaux et d'analyser nuestro tráfico. Nous partageons también des informations sur l'utilisation de nuestro site con sus partenaires de médias sociaux, de publicidad et d'analyse.</p>
            </div>
